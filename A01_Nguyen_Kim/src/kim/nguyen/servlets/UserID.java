/**
 * UserID.java demonstrates how to solve problems with multiple threads try to access to the same servlet's service
...
public class UserID extends HttpServlet {
    private static final long serialVersionUID = 3386576970611252128L;
