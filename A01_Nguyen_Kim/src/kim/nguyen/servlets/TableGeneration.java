/**
 * TableGeneration.java generates an HTML table with 25 rows and 10 columns.
 * 
 * @version %I%, %G%
 * 
 * @author Kim Nguyen
...
public class TableGeneration extends HttpServlet {
	
    private static final long serialVersionUID = -8666653285421156890L;
